        ...
        dataTable: [
          {
            fields: [
                { id: 'TypeDepense', type: 'select', label: 'Type Dépense', options: [
                    { value: 'Facturereçue', label: ' Facture reçue', selected: false },
                    { value: 'Rembourser', label: 'Rembourser',selected: false},
                    { value: 'Avance', label: 'Avance',selected: true },
                ...
                { id: 'NumeroFactureReçu',value:"Test 1", type: 'input', label: 'Numéro Facture, Reçu', inputType: 'text', placeholder: ' ', required: true, classes: 'block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer' },
                { id: 'NomSocieteFournisseur',value:"Test 1", type: 'select', label: 'Nom Société, Fournisseur', options: [
                    { value: 'Nom F', label: 'Nom F',selected: false },
                    { value: 'Nom F', label: 'Nom F',selected: false },
                    { value: 'Nom F', label: 'Nom F',selected: true },
                ], classes: 'block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer' },
                { id: 'DateFactureReçu',value:"Test 1", type: 'input', label: 'Date Facture & Reçu', inputType: 'date', placeholder: ' ', required: true, classes: 'block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer' },
